...
import type { V2Stream200ResponseOneOf } from './V2Stream200ResponseOneOf';
import {
    instanceOfV2Stream200ResponseOneOf,
    V2Stream200ResponseOneOfFromJSON,
    V2Stream200ResponseOneOfFromJSONTyped,
    V2Stream200ResponseOneOfToJSON,
} from './V2Stream200ResponseOneOf';
import type { V2Stream200ResponseOneOf1 } from './V2Stream200ResponseOneOf1';
import {
    instanceOfV2Stream200ResponseOneOf1,
    V2Stream200ResponseOneOf1FromJSON,
    V2Stream200ResponseOneOf1FromJSONTyped,
    V2Stream200ResponseOneOf1ToJSON,
} from './V2Stream200ResponseOneOf1';
 ...
 * @export
 */
export type V2Stream200Response = V2Stream200ResponseOneOf | V2Stream200ResponseOneOf1;

export function V2Stream200ResponseFromJSON(json: any): V2Stream200Response {
    return V2Stream200ResponseFromJSONTyped(json, false);
}

export function V2Stream200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2Stream200Response {
    if (json == null) {
        return json;
    }
    ...
    if (instanceOfV2Stream200ResponseOneOf(json)) {
        return V2Stream200ResponseOneOfFromJSONTyped(json, true);
    }
    if (instanceOfV2Stream200ResponseOneOf1(json)) {
        return V2Stream200ResponseOneOf1FromJSONTyped(json, true);
    }
    return {} as any;
}

export function V2Stream200ResponseToJSON(json: any): any {
    return V2Stream200ResponseToJSONTyped(json, false);
}

export function V2Stream200ResponseToJSONTyped(value?: V2Stream200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (instanceOfV2Stream200ResponseOneOf(value)) {
        return V2Stream200ResponseOneOfToJSON(value as V2Stream200ResponseOneOf);
    }
    if (instanceOfV2Stream200ResponseOneOf1(value)) {
        return V2Stream200ResponseOneOf1ToJSON(value as V2Stream200ResponseOneOf1);
    }
    return {};
}
