 ...
 * 
 * @export
 * @interface V2Currencies200ResponseCurrenciesInner
 */
export interface V2Currencies200ResponseCurrenciesInner {
    /**
     * An uppercase currency code as defined by the Currencies endpoint
     * @type {string}
     * @memberof V2Currencies200ResponseCurrenciesInner
     */
    code: string;
    /**
     * 
...
/**
 * Check if a given object implements the V2Currencies200ResponseCurrenciesInner interface.
 */
export function instanceOfV2Currencies200ResponseCurrenciesInner(value: object): value is V2Currencies200ResponseCurrenciesInner {
    if (!('code' in value) || value['code'] === undefined) return false;
    if (!('description' in value) || value['description'] === undefined) return false;
    return true;
}

export function V2Currencies200ResponseCurrenciesInnerFromJSON(json: any): V2Currencies200ResponseCurrenciesInner {
    return V2Currencies200ResponseCurrenciesInnerFromJSONTyped(json, false);
}

export function V2Currencies200ResponseCurrenciesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2Currencies200ResponseCurrenciesInner {
    if (json == null) {
        return json;
    }
    return {
...
export function V2Currencies200ResponseCurrenciesInnerToJSON(json: any): V2Currencies200ResponseCurrenciesInner {
    return V2Currencies200ResponseCurrenciesInnerToJSONTyped(json, false);
}

export function V2Currencies200ResponseCurrenciesInnerToJSONTyped(value?: V2Currencies200ResponseCurrenciesInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
