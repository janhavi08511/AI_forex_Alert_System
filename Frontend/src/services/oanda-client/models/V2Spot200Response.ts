...
import type { V2Spot200ResponseQuotesInner } from './V2Spot200ResponseQuotesInner';
import {
    V2Spot200ResponseQuotesInnerFromJSON,
    V2Spot200ResponseQuotesInnerFromJSONTyped,
    V2Spot200ResponseQuotesInnerToJSON,
    V2Spot200ResponseQuotesInnerToJSONTyped,
} from './V2Spot200ResponseQuotesInner';

/**
 * 
 * @export
 * @interface V2Spot200Response
 */
export interface V2Spot200Response {
    /**
     * 
     * @type {Meta}
     * @memberof V2Spot200Response
     */
    meta: Meta;
    /**
     * 
     * @type {Array<V2Spot200ResponseQuotesInner>}
     * @memberof V2Spot200Response
     */
    quotes: Array<V2Spot200ResponseQuotesInner>;
}

/**
 * Check if a given object implements the V2Spot200Response interface.
 */
export function instanceOfV2Spot200Response(value: object): value is V2Spot200Response {
    if (!('meta' in value) || value['meta'] === undefined) return false;
    if (!('quotes' in value) || value['quotes'] === undefined) return false;
    return true;
}

export function V2Spot200ResponseFromJSON(json: any): V2Spot200Response {
    return V2Spot200ResponseFromJSONTyped(json, false);
}

export function V2Spot200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2Spot200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'quotes': ((json['quotes'] as Array<any>).map(V2Spot200ResponseQuotesInnerFromJSON)),
    };
}

export function V2Spot200ResponseToJSON(json: any): V2Spot200Response {
    return V2Spot200ResponseToJSONTyped(json, false);
}

export function V2Spot200ResponseToJSONTyped(value?: V2Spot200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'quotes': ((value['quotes'] as Array<any>).map(V2Spot200ResponseQuotesInnerToJSON)),
    };
}
