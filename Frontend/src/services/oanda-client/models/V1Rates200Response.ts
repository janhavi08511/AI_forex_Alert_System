...
import type { V1Rates200ResponseQuotesValue } from './V1Rates200ResponseQuotesValue';
import {
    V1Rates200ResponseQuotesValueFromJSON,
    V1Rates200ResponseQuotesValueFromJSONTyped,
    V1Rates200ResponseQuotesValueToJSON,
    V1Rates200ResponseQuotesValueToJSONTyped,
} from './V1Rates200ResponseQuotesValue';

/**
 * 
 * @export
 * @interface V1Rates200Response
 */
export interface V1Rates200Response {
    /**
     * An uppercase currency code as defined by the Currencies endpoint
     * @type {string}
     * @memberof V1Rates200Response
     */
    baseCurrency: string;
    /**
     * 
    ...
    /**
     * 
     * @type {{ [key: string]: V1Rates200ResponseQuotesValue; }}
     * @memberof V1Rates200Response
     */
    quotes: { [key: string]: V1Rates200ResponseQuotesValue; };
}

/**
 * Check if a given object implements the V1Rates200Response interface.
 */
export function instanceOfV1Rates200Response(value: object): value is V1Rates200Response {
...
export function V1Rates200ResponseFromJSON(json: any): V1Rates200Response {
    return V1Rates200ResponseFromJSONTyped(json, false);
}

export function V1Rates200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1Rates200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'meta': V1MetaFromJSON(json['meta']),
        'quotes': (mapValues(json['quotes'], V1Rates200ResponseQuotesValueFromJSON)),
    };
}

export function V1Rates200ResponseToJSON(json: any): V1Rates200Response {
    return V1Rates200ResponseToJSONTyped(json, false);
}

export function V1Rates200ResponseToJSONTyped(value?: V1Rates200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'quotes': (mapValues(value['quotes'], V1Rates200ResponseQuotesValueToJSON)),
    };
}
