 ...
 * 
 * @export
 * @interface V1Rates404Response
 */
export interface V1Rates404Response {
    /**
     * 
     * @type {V1Rates404ResponseCodeEnum}
     * @memberof V1Rates404Response
     */
    code: V1Rates404ResponseCodeEnum;
    /**
     * 
     * @type {V1Rates404ResponseMessageEnum}
     * @memberof V1Rates404Response
     */
    message: V1Rates404ResponseMessageEnum;
}
 ...
 * @export
 */
export const V1Rates404ResponseCodeEnum = {
    NUMBER_56: 56
} as const;
export type V1Rates404ResponseCodeEnum = typeof V1Rates404ResponseCodeEnum[keyof typeof V1Rates404ResponseCodeEnum];

/**
 * @export
 */
export const V1Rates404ResponseMessageEnum = {
    TheRatesRequestedHaveNotYetBeenPublished: 'The rates requested have not yet been published'
} as const;
export type V1Rates404ResponseMessageEnum = typeof V1Rates404ResponseMessageEnum[keyof typeof V1Rates404ResponseMessageEnum];


/**
 * Check if a given object implements the V1Rates404Response interface.
 */
export function instanceOfV1Rates404Response(value: object): value is V1Rates404Response {
    if (!('code' in value) || value['code'] === undefined) return false;
    
    if (value['code'] !== 56) return false;
    if (!('message' in value) || value['message'] === undefined) return false;
    if (value['message'] !== 'The rates requested have not yet been published') return false;
    
    return true;
}

export function V1Rates404ResponseFromJSON(json: any): V1Rates404Response {
    return V1Rates404ResponseFromJSONTyped(json, false);
}

export function V1Rates404ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1Rates404Response {
    if (json == null) {
        return json;
    }
    return {
...
export function V1Rates404ResponseToJSON(json: any): V1Rates404Response {
    return V1Rates404ResponseToJSONTyped(json, false);
}

export function V1Rates404ResponseToJSONTyped(value?: V1Rates404Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
