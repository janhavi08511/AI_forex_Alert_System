 ...
 * 
 * @export
 * @interface V3InstrumentsOrderBook200Response
 */
export interface V3InstrumentsOrderBook200Response {
    /**
     * 
     * @type {V3InstrumentsOrderBook200ResponseOrderBook}
     * @memberof V3InstrumentsOrderBook200Response
     */
    orderBook: V3InstrumentsOrderBook200ResponseOrderBook;
}

/**
 * Check if a given object implements the V3InstrumentsOrderBook200Response interface.
 */
export function instanceOfV3InstrumentsOrderBook200Response(value: object): value is V3InstrumentsOrderBook200Response {
    if (!('orderBook' in value) || value['orderBook'] === undefined) return false;
    return true;
}

export function V3InstrumentsOrderBook200ResponseFromJSON(json: any): V3InstrumentsOrderBook200Response {
    return V3InstrumentsOrderBook200ResponseFromJSONTyped(json, false);
}

export function V3InstrumentsOrderBook200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V3InstrumentsOrderBook200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'orderBook': V3InstrumentsOrderBook200ResponseOrderBookFromJSON(json['orderBook']),
    };
}

export function V3InstrumentsOrderBook200ResponseToJSON(json: any): V3InstrumentsOrderBook200Response {
    return V3InstrumentsOrderBook200ResponseToJSONTyped(json, false);
}

export function V3InstrumentsOrderBook200ResponseToJSONTyped(value?: V3InstrumentsOrderBook200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'orderBook': V3InstrumentsOrderBook200ResponseOrderBookToJSON(value['orderBook']),
    };
}
