 ...
 * Spot Rates
 * @export
 * @interface V2Stream200ResponseOneOf
 */
export interface V2Stream200ResponseOneOf {
    /**
     * 
     * @type {OandaAndCBDataset}
     * @memberof V2Stream200ResponseOneOf
     */
...
/**
 * Check if a given object implements the V2Stream200ResponseOneOf interface.
 */
export function instanceOfV2Stream200ResponseOneOf(value: object): value is V2Stream200ResponseOneOf {
...
export function V2Stream200ResponseOneOfFromJSON(json: any): V2Stream200ResponseOneOf {
    return V2Stream200ResponseOneOfFromJSONTyped(json, false);
}

export function V2Stream200ResponseOneOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2Stream200ResponseOneOf {
    if (json == null) {
        return json;
    }
    return {
...
export function V2Stream200ResponseOneOfToJSON(json: any): V2Stream200ResponseOneOf {
    return V2Stream200ResponseOneOfToJSONTyped(json, false);
}

export function V2Stream200ResponseOneOfToJSONTyped(value?: V2Stream200ResponseOneOf | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
