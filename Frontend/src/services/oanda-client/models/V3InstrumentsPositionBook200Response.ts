...
import type { V3InstrumentsOrderBook200ResponseOrderBook } from './V3InstrumentsOrderBook200ResponseOrderBook';
import {
    V3InstrumentsOrderBook200ResponseOrderBookFromJSON,
    V3InstrumentsOrderBook200ResponseOrderBookFromJSONTyped,
    V3InstrumentsOrderBook200ResponseOrderBookToJSON,
    V3InstrumentsOrderBook200ResponseOrderBookToJSONTyped,
} from './V3InstrumentsOrderBook200ResponseOrderBook';

/**
 * 
 * @export
 * @interface V3InstrumentsPositionBook200Response
 */
export interface V3InstrumentsPositionBook200Response {
    /**
     * 
     * @type {V3InstrumentsOrderBook200ResponseOrderBook}
     * @memberof V3InstrumentsPositionBook200Response
     */
    positionBook: V3InstrumentsOrderBook200ResponseOrderBook;
}

/**
 * Check if a given object implements the V3InstrumentsPositionBook200Response interface.
 */
export function instanceOfV3InstrumentsPositionBook200Response(value: object): value is V3InstrumentsPositionBook200Response {
    if (!('positionBook' in value) || value['positionBook'] === undefined) return false;
    return true;
}

export function V3InstrumentsPositionBook200ResponseFromJSON(json: any): V3InstrumentsPositionBook200Response {
    return V3InstrumentsPositionBook200ResponseFromJSONTyped(json, false);
}

export function V3InstrumentsPositionBook200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V3InstrumentsPositionBook200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'positionBook': V3InstrumentsOrderBook200ResponseOrderBookFromJSON(json['positionBook']),
    };
}

export function V3InstrumentsPositionBook200ResponseToJSON(json: any): V3InstrumentsPositionBook200Response {
    return V3InstrumentsPositionBook200ResponseToJSONTyped(json, false);
}

export function V3InstrumentsPositionBook200ResponseToJSONTyped(value?: V3InstrumentsPositionBook200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'positionBook': V3InstrumentsOrderBook200ResponseOrderBookToJSON(value['positionBook']),
    };
}
