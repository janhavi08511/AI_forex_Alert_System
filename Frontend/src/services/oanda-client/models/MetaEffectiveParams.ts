 ...
 * @export
 * @interface MetaEffectiveParams
 */
export interface MetaEffectiveParams {
    /**
     * 
     * @type {Dataset}
     * @memberof MetaEffectiveParams
     */
    dataSet: Dataset;
    /**
     * 
...
/**
 * Check if a given object implements the MetaEffectiveParams interface.
 */
export function instanceOfMetaEffectiveParams(value: object): value is MetaEffectiveParams {
    if ((!('dataSet' in value) && !('data_set' in value)) || (value['dataSet'] === undefined && value['data_set'] === undefined)) return false;
    if ((!('baseCurrencies' in value) && !('base_currencies' in value)) || (value['baseCurrencies'] === undefined && value['base_currencies'] === undefined)) return false;
...
export function MetaEffectiveParamsFromJSON(json: any): MetaEffectiveParams {
    return MetaEffectiveParamsFromJSONTyped(json, false);
}

export function MetaEffectiveParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetaEffectiveParams {
    if (json == null) {
        return json;
    }
    return {
        ...
        'baseCurrencies': json['base_currencies'],
        'quoteCurrencies': json['quote_currencies'],
        'dateTime': json['date_time'] == null ? undefined : json['date_time'],
    };
}

export function MetaEffectiveParamsToJSON(json: any): MetaEffectiveParams {
    return MetaEffectiveParamsToJSONTyped(json, false);
}

export function MetaEffectiveParamsToJSONTyped(value?: MetaEffectiveParams | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'base_currencies': value['baseCurrencies'],
