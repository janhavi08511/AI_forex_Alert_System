...
import type { V2Currencies200ResponseCurrenciesInner } from './V2Currencies200ResponseCurrenciesInner';
import {
    V2Currencies200ResponseCurrenciesInnerFromJSON,
    V2Currencies200ResponseCurrenciesInnerFromJSONTyped,
    V2Currencies200ResponseCurrenciesInnerToJSON,
    V2Currencies200ResponseCurrenciesInnerToJSONTyped,
} from './V2Currencies200ResponseCurrenciesInner';

/**
 * 
 * @export
 * @interface V2Currencies200Response
 */
export interface V2Currencies200Response {
    /**
     * 
     * @type {Array<V2Currencies200ResponseCurrenciesInner>}
     * @memberof V2Currencies200Response
     */
    currencies: Array<V2Currencies200ResponseCurrenciesInner>;
}

/**
 * Check if a given object implements the V2Currencies200Response interface.
 */
export function instanceOfV2Currencies200Response(value: object): value is V2Currencies200Response {
    if (!('currencies' in value) || value['currencies'] === undefined) return false;
    return true;
}

export function V2Currencies200ResponseFromJSON(json: any): V2Currencies200Response {
    return V2Currencies200ResponseFromJSONTyped(json, false);
}

export function V2Currencies200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2Currencies200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'currencies': ((json['currencies'] as Array<any>).map(V2Currencies200ResponseCurrenciesInnerFromJSON)),
    };
}

export function V2Currencies200ResponseToJSON(json: any): V2Currencies200Response {
    return V2Currencies200ResponseToJSONTyped(json, false);
}

export function V2Currencies200ResponseToJSONTyped(value?: V2Currencies200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'currencies': ((value['currencies'] as Array<any>).map(V2Currencies200ResponseCurrenciesInnerToJSON)),
    };
}
