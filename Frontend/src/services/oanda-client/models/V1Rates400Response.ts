 ...
 * 
 * @export
 * @interface V1Rates400Response
 */
export interface V1Rates400Response {
    /**
     * 
     * @type {V1Rates400ResponseCodeEnum}
     * @memberof V1Rates400Response
     */
    code: V1Rates400ResponseCodeEnum;
    /**
     * 
     * @type {V1Rates400ResponseMessageEnum}
     * @memberof V1Rates400Response
     */
    message: V1Rates400ResponseMessageEnum;
}
 ...
 * @export
 */
export const V1Rates400ResponseCodeEnum = {
    NUMBER_1: 1,
    NUMBER_2: 2,
    NUMBER_8: 8,
    NUMBER_55: 55
} as const;
export type V1Rates400ResponseCodeEnum = typeof V1Rates400ResponseCodeEnum[keyof typeof V1Rates400ResponseCodeEnum];

/**
 * @export
 */
export const V1Rates400ResponseMessageEnum = {
    InvalidOrMalformedArgumentTheArgumentSpecifiedIsNotProperlyFormattedOrIsAnUnacceptedValue: 'Invalid or malformed argument  The argument specified is not properly formatted or is an unaccepted value',
    MissingRequiredArgument: 'Missing required argument',
    MalformedAuthorizationHeaderOrInvalidAccessToken: 'Malformed Authorization header or invalid access token',
    TheCombinationsOfCurrencyPairsAndDatesMayNotExceedTheLimitAllowedPerRequest: 'The combinations of currency pairs and dates may not exceed the limit allowed per request'
} as const;
export type V1Rates400ResponseMessageEnum = typeof V1Rates400ResponseMessageEnum[keyof typeof V1Rates400ResponseMessageEnum];


/**
 * Check if a given object implements the V1Rates400Response interface.
 */
export function instanceOfV1Rates400Response(value: object): value is V1Rates400Response {
    if (!('code' in value) || value['code'] === undefined) return false;
    if (!('message' in value) || value['message'] === undefined) return false;
    return true;
}

export function V1Rates400ResponseFromJSON(json: any): V1Rates400Response {
    return V1Rates400ResponseFromJSONTyped(json, false);
}

export function V1Rates400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1Rates400Response {
    if (json == null) {
        return json;
    }
    return {
...
export function V1Rates400ResponseToJSON(json: any): V1Rates400Response {
    return V1Rates400ResponseToJSONTyped(json, false);
}

export function V1Rates400ResponseToJSONTyped(value?: V1Rates400Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
