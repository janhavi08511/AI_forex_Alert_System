...
import type { OandaAndCBDataset } from './OandaAndCBDataset';
import {
    OandaAndCBDatasetFromJSON,
    OandaAndCBDatasetFromJSONTyped,
    OandaAndCBDatasetToJSON,
    OandaAndCBDatasetToJSONTyped,
} from './OandaAndCBDataset';

/**
 * Forward Rates
 * @export
 * @interface V2Stream200ResponseOneOf1
 */
export interface V2Stream200ResponseOneOf1 {
    /**
     * 
     * @type {OandaAndCBDataset}
     * @memberof V2Stream200ResponseOneOf1
     */
    ...
    quote: string;
    /**
     * The most recent timestamp of the exchange rates were recorded
     * @type {string}
     * @memberof V2Stream200ResponseOneOf1
     */
    timestamp: string;
...
/**
 * Check if a given object implements the V2Stream200ResponseOneOf1 interface.
 */
export function instanceOfV2Stream200ResponseOneOf1(value: object): value is V2Stream200ResponseOneOf1 {
...
export function V2Stream200ResponseOneOf1FromJSON(json: any): V2Stream200ResponseOneOf1 {
    return V2Stream200ResponseOneOf1FromJSONTyped(json, false);
}

export function V2Stream200ResponseOneOf1FromJSONTyped(json: any, ignoreDiscriminator: boolean): V2Stream200ResponseOneOf1 {
    if (json == null) {
        return json;
    }
    return {
        
        'dataset': OandaAndCBDatasetFromJSON(json['dataset']),
        'base': json['base'],
        'quote': json['quote'],
...
export function V2Stream200ResponseOneOf1ToJSON(json: any): V2Stream200ResponseOneOf1 {
    return V2Stream200ResponseOneOf1ToJSONTyped(json, false);
}

export function V2Stream200ResponseOneOf1ToJSONTyped(value?: V2Stream200ResponseOneOf1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'dataset': OandaAndCBDatasetToJSON(value['dataset']),
        'base': value['base'],
        'quote': value['quote'],
