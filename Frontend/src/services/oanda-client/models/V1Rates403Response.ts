 ...
 * 
 * @export
 * @interface V1Rates403Response
 */
export interface V1Rates403Response {
    /**
     * 
     * @type {V1Rates403ResponseCodeEnum}
     * @memberof V1Rates403Response
     */
    code: V1Rates403ResponseCodeEnum;
    /**
     * 
     * @type {V1Rates403ResponseMessageEnum}
     * @memberof V1Rates403Response
     */
    message: V1Rates403ResponseMessageEnum;
}
 ...
 * @export
 */
export const V1Rates403ResponseCodeEnum = {
    NUMBER_4: 4,
    NUMBER_53: 53,
    NUMBER_54: 54
} as const;
export type V1Rates403ResponseCodeEnum = typeof V1Rates403ResponseCodeEnum[keyof typeof V1Rates403ResponseCodeEnum];

/**
 * @export
 */
export const V1Rates403ResponseMessageEnum = {
    TheAccessTokenProvidedDoesNotAllowThisRequestToBemadeTheProvidedApiKeyDoesNotHavePrivilegeForTheRequestNoAccessToCentralBankRatesIsOneInstance: 'The access token provided does not allow this request to be made  The provided API key does not have privilege for the request (no access to Central Bank rates is one instance)',
    RateLimitViolationYouHaveExceededYourAllocationOfQuotesForTheCurrentBillingPeriod: 'Rate limit violation        You have exceeded your allocation of quotes for the current billing period',
    ExpectedRatesReturnedFromThisApiCallIsMoreThanTheNumberOfQuotesRemainingForThisAccount: 'Expected rates returned from this API call is more than the number of quotes remaining for this account'
} as const;
export type V1Rates403ResponseMessageEnum = typeof V1Rates403ResponseMessageEnum[keyof typeof V1Rates403ResponseMessageEnum];


/**
 * Check if a given object implements the V1Rates403Response interface.
 */
export function instanceOfV1Rates403Response(value: object): value is V1Rates403Response {
    if (!('code' in value) || value['code'] === undefined) return false;
    if (!('message' in value) || value['message'] === undefined) return false;
    return true;
}

export function V1Rates403ResponseFromJSON(json: any): V1Rates403Response {
    return V1Rates403ResponseFromJSONTyped(json, false);
}

export function V1Rates403ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1Rates403Response {
    if (json == null) {
        return json;
    }
    return {
...
export function V1Rates403ResponseToJSON(json: any): V1Rates403Response {
    return V1Rates403ResponseToJSONTyped(json, false);
}

export function V1Rates403ResponseToJSONTyped(value?: V1Rates403Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
