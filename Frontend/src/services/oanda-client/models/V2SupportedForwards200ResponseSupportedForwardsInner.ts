 ...
 * 
 * @export
 * @interface V2SupportedForwards200ResponseSupportedForwardsInner
 */
export interface V2SupportedForwards200ResponseSupportedForwardsInner {
    /**
     * An uppercase currency code as defined by the Currencies endpoint
     * @type {string}
     * @memberof V2SupportedForwards200ResponseSupportedForwardsInner
     */
    baseCurrency: string;
    /**
     * An uppercase currency code as defined by the Currencies endpoint
...
/**
 * Check if a given object implements the V2SupportedForwards200ResponseSupportedForwardsInner interface.
 */
export function instanceOfV2SupportedForwards200ResponseSupportedForwardsInner(value: object): value is V2SupportedForwards200ResponseSupportedForwardsInner {
...
export function V2SupportedForwards200ResponseSupportedForwardsInnerFromJSON(json: any): V2SupportedForwards200ResponseSupportedForwardsInner {
    return V2SupportedForwards200ResponseSupportedForwardsInnerFromJSONTyped(json, false);
}

export function V2SupportedForwards200ResponseSupportedForwardsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2SupportedForwards200ResponseSupportedForwardsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function V2SupportedForwards200ResponseSupportedForwardsInnerToJSON(json: any): V2SupportedForwards200ResponseSupportedForwardsInner {
    return V2SupportedForwards200ResponseSupportedForwardsInnerToJSONTyped(json, false);
}

export function V2SupportedForwards200ResponseSupportedForwardsInnerToJSONTyped(value?: V2SupportedForwards200ResponseSupportedForwardsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
