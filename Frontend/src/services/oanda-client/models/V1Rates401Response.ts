 ...
 * 
 * @export
 * @interface V1Rates401Response
 */
export interface V1Rates401Response {
    /**
     * 
     * @type {V1Rates401ResponseCodeEnum}
     * @memberof V1Rates401Response
     */
    code: V1Rates401ResponseCodeEnum;
    /**
     * 
     * @type {V1Rates401ResponseMessageEnum}
     * @memberof V1Rates401Response
     */
    message: V1Rates401ResponseMessageEnum;
}
 ...
 * @export
 */
export const V1Rates401ResponseCodeEnum = {
    NUMBER_3: 3
} as const;
export type V1Rates401ResponseCodeEnum = typeof V1Rates401ResponseCodeEnum[keyof typeof V1Rates401ResponseCodeEnum];

/**
 * @export
 */
export const V1Rates401ResponseMessageEnum = {
    ThisRequestRequiresAuthorization: 'This request requires authorization'
} as const;
export type V1Rates401ResponseMessageEnum = typeof V1Rates401ResponseMessageEnum[keyof typeof V1Rates401ResponseMessageEnum];


/**
 * Check if a given object implements the V1Rates401Response interface.
 */
export function instanceOfV1Rates401Response(value: object): value is V1Rates401Response {
    if (!('code' in value) || value['code'] === undefined) return false;
    
    if (value['code'] !== 3) return false;
    if (!('message' in value) || value['message'] === undefined) return false;
    if (value['message'] !== 'This request requires authorization') return false;
    
    return true;
}

export function V1Rates401ResponseFromJSON(json: any): V1Rates401Response {
    return V1Rates401ResponseFromJSONTyped(json, false);
}

export function V1Rates401ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1Rates401Response {
    if (json == null) {
        return json;
    }
    return {
...
export function V1Rates401ResponseToJSON(json: any): V1Rates401Response {
    return V1Rates401ResponseToJSONTyped(json, false);
}

export function V1Rates401ResponseToJSONTyped(value?: V1Rates401Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
