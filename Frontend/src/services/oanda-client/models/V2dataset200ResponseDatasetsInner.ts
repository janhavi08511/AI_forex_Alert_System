 ...
 * 
 * @export
 * @interface V2dataset200ResponseDatasetsInner
 */
export interface V2dataset200ResponseDatasetsInner {
    /**
     * 
     * @type {string}
     * @memberof V2dataset200ResponseDatasetsInner
     */
    code: string;
    /**
     * 
     ...
     * @memberof V2dataset200ResponseDatasetsInner
     */
    quotables: Array<string>;
}

/**
 * Check if a given object implements the V2dataset200ResponseDatasetsInner interface.
 */
export function instanceOfV2dataset200ResponseDatasetsInner(value: object): value is V2dataset200ResponseDatasetsInner {
    if (!('code' in value) || value['code'] === undefined) return false;
    if (!('description' in value) || value['description'] === undefined) return false;
    if ((!('crossCurrency' in value) && !('cross_currency' in value)) || (value['crossCurrency'] === undefined && value['cross_currency'] === undefined)) return false;
    if (!('quotables' in value) || value['quotables'] === undefined) return false;
    return true;
}

export function V2dataset200ResponseDatasetsInnerFromJSON(json: any): V2dataset200ResponseDatasetsInner {
    return V2dataset200ResponseDatasetsInnerFromJSONTyped(json, false);
}

export function V2dataset200ResponseDatasetsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2dataset200ResponseDatasetsInner {
    if (json == null) {
        return json;
    }
    return {
        ...
        'crossCurrency': json['cross_currency'],
        'quotables': json['quotables'],
    };
}

export function V2dataset200ResponseDatasetsInnerToJSON(json: any): V2dataset200ResponseDatasetsInner {
    return V2dataset200ResponseDatasetsInnerToJSONTyped(json, false);
}

export function V2dataset200ResponseDatasetsInnerToJSONTyped(value?: V2dataset200ResponseDatasetsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'cross_currency': value['crossCurrency'],
        'quotables': value['quotables'],
    };
}
