 ...
 * 
 * @export
 * @interface V2Spot200ResponseQuotesInner
 */
export interface V2Spot200ResponseQuotesInner {
    /**
     * An uppercase currency code as defined by the Currencies endpoint
     * @type {string}
     * @memberof V2Spot200ResponseQuotesInner
     */
    baseCurrency: string;
    /**
     * An uppercase currency code as defined by the Currencies endpoint
    ...
    /**
     * When the 'spot' endpoint is called with a 'date_time' parameter, the derived 'date_time' is included in each quote.
     * @type {string}
     * @memberof V2Spot200ResponseQuotesInner
     */
    dateTime?: string;
...
/**
 * Check if a given object implements the V2Spot200ResponseQuotesInner interface.
 */
export function instanceOfV2Spot200ResponseQuotesInner(value: object): value is V2Spot200ResponseQuotesInner {
...
export function V2Spot200ResponseQuotesInnerFromJSON(json: any): V2Spot200ResponseQuotesInner {
    return V2Spot200ResponseQuotesInnerFromJSONTyped(json, false);
}

export function V2Spot200ResponseQuotesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2Spot200ResponseQuotesInner {
    if (json == null) {
        return json;
    }
    return {
...
export function V2Spot200ResponseQuotesInnerToJSON(json: any): V2Spot200ResponseQuotesInner {
    return V2Spot200ResponseQuotesInnerToJSONTyped(json, false);
}

export function V2Spot200ResponseQuotesInnerToJSONTyped(value?: V2Spot200ResponseQuotesInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
