...
import type { RemainingQuotes } from './RemainingQuotes';
import {
    RemainingQuotesFromJSON,
    RemainingQuotesFromJSONTyped,
    RemainingQuotesToJSON,
    RemainingQuotesToJSONTyped,
} from './RemainingQuotes';

/**
 * 
 * @export
 * @interface V2RemainingQuotes200Response
 */
export interface V2RemainingQuotes200Response {
    /**
     * 
     * @type {RemainingQuotes}
     * @memberof V2RemainingQuotes200Response
     */
    remainingQuotes: RemainingQuotes;
    /**
     * Number of quotes used during the current usage cycle
     * @type {number}
     * @memberof V2RemainingQuotes200Response
     */
    usedQuotes: number;
...
/**
 * Check if a given object implements the V2RemainingQuotes200Response interface.
 */
export function instanceOfV2RemainingQuotes200Response(value: object): value is V2RemainingQuotes200Response {
    if ((!('remainingQuotes' in value) && !('remaining_quotes' in value)) || (value['remainingQuotes'] === undefined && value['remaining_quotes'] === undefined)) return false;
    if ((!('usedQuotes' in value) && !('used_quotes' in value)) || (value['usedQuotes'] === undefined && value['used_quotes'] === undefined)) return false;
    return true;
}

export function V2RemainingQuotes200ResponseFromJSON(json: any): V2RemainingQuotes200Response {
    return V2RemainingQuotes200ResponseFromJSONTyped(json, false);
}

export function V2RemainingQuotes200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2RemainingQuotes200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'remainingQuotes': RemainingQuotesFromJSON(json['remaining_quotes']),
        'usedQuotes': json['used_quotes'],
    };
}

export function V2RemainingQuotes200ResponseToJSON(json: any): V2RemainingQuotes200Response {
    return V2RemainingQuotes200ResponseToJSONTyped(json, false);
}

export function V2RemainingQuotes200ResponseToJSONTyped(value?: V2RemainingQuotes200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'remaining_quotes': RemainingQuotesToJSON(value['remainingQuotes']),
        'used_quotes': value['usedQuotes'],
    };
}
