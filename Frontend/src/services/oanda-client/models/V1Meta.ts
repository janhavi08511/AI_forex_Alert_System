...
import type { V1MetaEffectiveParams } from './V1MetaEffectiveParams';
import {
    V1MetaEffectiveParamsFromJSON,
    V1MetaEffectiveParamsFromJSONTyped,
    V1MetaEffectiveParamsToJSON,
    V1MetaEffectiveParamsToJSONTyped,
} from './V1MetaEffectiveParams';
...
export interface V1Meta {
    /**
     * 
     * @type {V1MetaEffectiveParams}
     * @memberof V1Meta
     */
    effectiveParams: V1MetaEffectiveParams;
    /**
     * The UTC date and time that this request was made.
     * @type {string}
     * @memberof V1Meta
     */
    requestTime: string;
    /**
     * A list of currencies that were skipped due to the abscence of data for the requested date or date range.
     * @type {Array<string>}
     * @memberof V1Meta
     */
...
export function instanceOfV1Meta(value: object): value is V1Meta {
    ...
    if ((!('skippedCurrencies' in value) && !('skipped_currencies' in value)) || (value['skippedCurrencies'] === undefined && value['skipped_currencies'] === undefined)) return false;
    return true;
}
...
export function V1MetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1Meta {
    ...
    return {
        ...
        'effectiveParams': V1MetaEffectiveParamsFromJSON(json['effective_params']),
        'requestTime': json['request_time'],
        'skippedCurrencies': json['skipped_currencies'],
    };
}
...
export function V1MetaToJSONTyped(value?: V1Meta | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'effective_params': V1MetaEffectiveParamsToJSON(value['effectiveParams']),
        'request_time': value['requestTime'],
        'skipped_currencies': value['skippedCurrencies'],
    };
}
