...
import type { MetaSkippedCurrencyPairsInner } from './MetaSkippedCurrencyPairsInner';
import {
    MetaSkippedCurrencyPairsInnerFromJSON,
    MetaSkippedCurrencyPairsInnerFromJSONTyped,
    MetaSkippedCurrencyPairsInnerToJSON,
    MetaSkippedCurrencyPairsInnerToJSONTyped,
} from './MetaSkippedCurrencyPairsInner';
import type { MetaEffectiveParams } from './MetaEffectiveParams';
import {
    MetaEffectiveParamsFromJSON,
    MetaEffectiveParamsFromJSONTyped,
    MetaEffectiveParamsToJSON,
    MetaEffectiveParamsToJSONTyped,
} from './MetaEffectiveParams';
...
export interface Meta {
    /**
     * 
     * @type {MetaEffectiveParams}
     * @memberof Meta
     */
    effectiveParams: MetaEffectiveParams;
    /**
     ...
     * @type {Array<MetaSkippedCurrencyPairsInner>}
     * @memberof Meta
     */
    skippedCurrencyPairs: Array<MetaSkippedCurrencyPairsInner>;
    /**
     * 
     * @type {Array<string>}
     * @memberof Meta
...
export function instanceOfMeta(value: object): value is Meta {
    if ((!('effectiveParams' in value) && !('effective_params' in value)) || (value['effectiveParams'] === undefined && value['effective_params'] === undefined)) return false;
    if (!('endpoint' in value) || value['endpoint'] === undefined) return false;
    if ((!('requestTime' in value) && !('request_time' in value)) || (value['requestTime'] === undefined && value['request_time'] === undefined)) return false;
    if ((!('skippedCurrencyPairs' in value) && !('skipped_currency_pairs' in value)) || (value['skippedCurrencyPairs'] === undefined && value['skipped_currency_pairs'] === undefined)) return false;
    return true;
}
...
export function MetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): Meta {
    ...
    return {
        ...
        'effectiveParams': MetaEffectiveParamsFromJSON(json['effective_params']),
        'endpoint': json['endpoint'],
        'requestTime': json['request_time'],
        'skippedCurrencyPairs': ((json['skipped_currency_pairs'] as Array<any>).map(MetaSkippedCurrencyPairsInnerFromJSON)),
        'skippedTenors': json['skipped_tenors'] == null ? undefined : json['skipped_tenors'],
    };
}
...
export function MetaToJSONTyped(value?: Meta | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'effective_params': MetaEffectiveParamsToJSON(value['effectiveParams']),
        'endpoint': value['endpoint'],
        'request_time': value['requestTime'],
        'skipped_currency_pairs': ((value['skippedCurrencyPairs'] as Array<any>).map(MetaSkippedCurrencyPairsInnerToJSON)),
        'skipped_tenors': value['skippedTenors'],
    };
}
