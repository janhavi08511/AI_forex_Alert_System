 ...
 * 
 * @export
 * @interface V2Aggregated200ResponseQuotesInner
 */
export interface V2Aggregated200ResponseQuotesInner {
    /**
     * An uppercase currency code as defined by the Currencies endpoint
     * @type {string}
     * @memberof V2Aggregated200ResponseQuotesInner
     */
    baseCurrency: string;
    /**
     * An uppercase currency code as defined by the Currencies endpoint
    ...
    /**
     * The effective start of the candle
     * @type {string}
     * @memberof V2Aggregated200ResponseQuotesInner
     */
    startTime: string;
    /**
     * The effective end of the candle
     * @type {string}
     * @memberof V2Aggregated200ResponseQuotesInner
     */
    endTime?: string;
...
/**
 * Check if a given object implements the V2Aggregated200ResponseQuotesInner interface.
 */
export function instanceOfV2Aggregated200ResponseQuotesInner(value: object): value is V2Aggregated200ResponseQuotesInner {
...
export function V2Aggregated200ResponseQuotesInnerFromJSON(json: any): V2Aggregated200ResponseQuotesInner {
    return V2Aggregated200ResponseQuotesInnerFromJSONTyped(json, false);
}

export function V2Aggregated200ResponseQuotesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2Aggregated200ResponseQuotesInner {
    if (json == null) {
        return json;
    }
    return {
...
export function V2Aggregated200ResponseQuotesInnerToJSON(json: any): V2Aggregated200ResponseQuotesInner {
    return V2Aggregated200ResponseQuotesInnerToJSONTyped(json, false);
}

export function V2Aggregated200ResponseQuotesInnerToJSONTyped(value?: V2Aggregated200ResponseQuotesInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
