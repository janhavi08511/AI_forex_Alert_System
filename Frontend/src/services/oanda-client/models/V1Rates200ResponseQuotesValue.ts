 ...
 * 
 * @export
 * @interface V1Rates200ResponseQuotesValue
 */
export interface V1Rates200ResponseQuotesValue {
    /**
     * Rates are encoded as string to prevent rounding issues
     * @type {string}
     * @memberof V1Rates200ResponseQuotesValue
     */
    ask?: string;
    /**
     * Rates are encoded as string to prevent rounding issues
...
/**
 * Check if a given object implements the V1Rates200ResponseQuotesValue interface.
 */
export function instanceOfV1Rates200ResponseQuotesValue(value: object): value is V1Rates200ResponseQuotesValue {
    if (!('date' in value) || value['date'] === undefined) return false;
    return true;
}

export function V1Rates200ResponseQuotesValueFromJSON(json: any): V1Rates200ResponseQuotesValue {
    return V1Rates200ResponseQuotesValueFromJSONTyped(json, false);
}

export function V1Rates200ResponseQuotesValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1Rates200ResponseQuotesValue {
    if (json == null) {
        return json;
    }
    return {
...
export function V1Rates200ResponseQuotesValueToJSON(json: any): V1Rates200ResponseQuotesValue {
    return V1Rates200ResponseQuotesValueToJSONTyped(json, false);
}

export function V1Rates200ResponseQuotesValueToJSONTyped(value?: V1Rates200ResponseQuotesValue | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
