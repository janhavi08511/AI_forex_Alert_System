...
import type { V2Candle } from './V2Candle';
import {
    V2CandleFromJSON,
    V2CandleFromJSONTyped,
    V2CandleToJSON,
    V2CandleToJSONTyped,
} from './V2Candle';
 ...
 * 
 * @export
 * @interface V2Candle200Response
 */
export interface V2Candle200Response {
    /**
     * 
     * @type {Meta}
     * @memberof V2Candle200Response
     */
    meta: Meta;
    /**
     * Contains a list of all the data objects returned
     * for the request.
     * 
     * For Spot, Candle, Candles, and Aggregated endpoints, quotes are ordered by the
     * `base_currency`, `quote_currency` alphabetically, both of which are present in
     * all quotes, and finally any applicable date-time fields.
     * 
     * For Forward endpoints, quotes are ordered by `tenor` on their duration. Fields
     * present in each quote are dependent on the endpoint and request type, and are
     * described below.
     * @type {Array<V2Candle>}
     * @memberof V2Candle200Response
     */
    quotes: Array<V2Candle>;
}

/**
 * Check if a given object implements the V2Candle200Response interface.
 */
export function instanceOfV2Candle200Response(value: object): value is V2Candle200Response {
    if (!('meta' in value) || value['meta'] === undefined) return false;
    if (!('quotes' in value) || value['quotes'] === undefined) return false;
    return true;
}

export function V2Candle200ResponseFromJSON(json: any): V2Candle200Response {
    return V2Candle200ResponseFromJSONTyped(json, false);
}

export function V2Candle200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2Candle200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'quotes': ((json['quotes'] as Array<any>).map(V2CandleFromJSON)),
    };
}

export function V2Candle200ResponseToJSON(json: any): V2Candle200Response {
    return V2Candle200ResponseToJSONTyped(json, false);
}

export function V2Candle200ResponseToJSONTyped(value?: V2Candle200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'quotes': ((value['quotes'] as Array<any>).map(V2CandleToJSON)),
    };
}
