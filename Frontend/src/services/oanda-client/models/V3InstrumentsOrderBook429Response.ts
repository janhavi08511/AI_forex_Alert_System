 ...
 * 
 * @export
 * @interface V3InstrumentsOrderBook429Response
 */
export interface V3InstrumentsOrderBook429Response {
    /**
     * 
     * @type {V3InstrumentsOrderBook429ResponseCodeEnum}
     * @memberof V3InstrumentsOrderBook429Response
     */
    code: V3InstrumentsOrderBook429ResponseCodeEnum;
    /**
     * 
     * @type {V3InstrumentsOrderBook429ResponseMessageEnum}
     * @memberof V3InstrumentsOrderBook429Response
     */
    message: V3InstrumentsOrderBook429ResponseMessageEnum;
}
 ...
 * @export
 */
export const V3InstrumentsOrderBook429ResponseCodeEnum = {
    NUMBER_53: 53
} as const;
export type V3InstrumentsOrderBook429ResponseCodeEnum = typeof V3InstrumentsOrderBook429ResponseCodeEnum[keyof typeof V3InstrumentsOrderBook429ResponseCodeEnum];

/**
 * @export
 */
export const V3InstrumentsOrderBook429ResponseMessageEnum = {
    RateLimitViolation: 'Rate limit violation'
} as const;
export type V3InstrumentsOrderBook429ResponseMessageEnum = typeof V3InstrumentsOrderBook429ResponseMessageEnum[keyof typeof V3InstrumentsOrderBook429ResponseMessageEnum];


/**
 * Check if a given object implements the V3InstrumentsOrderBook429Response interface.
 */
export function instanceOfV3InstrumentsOrderBook429Response(value: object): value is V3InstrumentsOrderBook429Response {
    if (!('code' in value) || value['code'] === undefined) return false;
    
    if (value['code'] !== 53) return false;
    if (!('message' in value) || value['message'] === undefined) return false;
    if (value['message'] !== 'Rate limit violation') return false;
    
    return true;
}

export function V3InstrumentsOrderBook429ResponseFromJSON(json: any): V3InstrumentsOrderBook429Response {
    return V3InstrumentsOrderBook429ResponseFromJSONTyped(json, false);
}

export function V3InstrumentsOrderBook429ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V3InstrumentsOrderBook429Response {
    if (json == null) {
        return json;
    }
    return {
...
export function V3InstrumentsOrderBook429ResponseToJSON(json: any): V3InstrumentsOrderBook429Response {
    return V3InstrumentsOrderBook429ResponseToJSONTyped(json, false);
}

export function V3InstrumentsOrderBook429ResponseToJSONTyped(value?: V3InstrumentsOrderBook429Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
