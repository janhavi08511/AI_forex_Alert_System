 ...
 * @export
 */
export const OandaDataset = {
    Oanda: 'OANDA',
    Crypto: 'CRYPTO'
} as const;
export type OandaDataset = typeof OandaDataset[keyof typeof OandaDataset];


export function instanceOfOandaDataset(value: any): boolean {
    for (const key in OandaDataset) {
        if (Object.prototype.hasOwnProperty.call(OandaDataset, key)) {
            if (OandaDataset[key as keyof typeof OandaDataset] === value) {
                return true;
            }
        }
    }
...
export function OandaDatasetFromJSON(json: any): OandaDataset {
    return OandaDatasetFromJSONTyped(json, false);
}

export function OandaDatasetFromJSONTyped(json: any, ignoreDiscriminator: boolean): OandaDataset {
    return json as OandaDataset;
}

export function OandaDatasetToJSON(value?: OandaDataset | null): any {
    return value as any;
}

export function OandaDatasetToJSONTyped(value: any, ignoreDiscriminator: boolean): OandaDataset {
    return value as OandaDataset;
}
