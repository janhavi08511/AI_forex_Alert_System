...
import type { V2dataset200ResponseDatasetsInner } from './V2dataset200ResponseDatasetsInner';
import {
    V2dataset200ResponseDatasetsInnerFromJSON,
    V2dataset200ResponseDatasetsInnerFromJSONTyped,
    V2dataset200ResponseDatasetsInnerToJSON,
    V2dataset200ResponseDatasetsInnerToJSONTyped,
} from './V2dataset200ResponseDatasetsInner';

/**
 * 
 * @export
 * @interface V2dataset200Response
 */
export interface V2dataset200Response {
    /**
     * 
     * @type {Array<V2dataset200ResponseDatasetsInner>}
     * @memberof V2dataset200Response
     */
    datasets: Array<V2dataset200ResponseDatasetsInner>;
}

/**
 * Check if a given object implements the V2dataset200Response interface.
 */
export function instanceOfV2dataset200Response(value: object): value is V2dataset200Response {
    if (!('datasets' in value) || value['datasets'] === undefined) return false;
    return true;
}

export function V2dataset200ResponseFromJSON(json: any): V2dataset200Response {
    return V2dataset200ResponseFromJSONTyped(json, false);
}

export function V2dataset200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2dataset200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'datasets': ((json['datasets'] as Array<any>).map(V2dataset200ResponseDatasetsInnerFromJSON)),
    };
}

export function V2dataset200ResponseToJSON(json: any): V2dataset200Response {
    return V2dataset200ResponseToJSONTyped(json, false);
}

export function V2dataset200ResponseToJSONTyped(value?: V2dataset200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'datasets': ((value['datasets'] as Array<any>).map(V2dataset200ResponseDatasetsInnerToJSON)),
    };
}
