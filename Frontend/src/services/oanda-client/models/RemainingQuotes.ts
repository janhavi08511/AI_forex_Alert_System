 ...
 * If your plan is not quote limited, this will be the string 'unlimited'.
 * @export
 */
export type RemainingQuotes = number | string;

export function RemainingQuotesFromJSON(json: any): RemainingQuotes {
    return RemainingQuotesFromJSONTyped(json, false);
}

export function RemainingQuotesFromJSONTyped(json: any, ignoreDiscriminator: boolean): RemainingQuotes {
    if (json == null) {
        return json;
    }
    ...
    if (typeof json === 'string' && (json === 'unlimited')) {
        return json;
    }
    return {} as any;
}

export function RemainingQuotesToJSON(json: any): any {
    return RemainingQuotesToJSONTyped(json, false);
}

export function RemainingQuotesToJSONTyped(value?: RemainingQuotes | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
