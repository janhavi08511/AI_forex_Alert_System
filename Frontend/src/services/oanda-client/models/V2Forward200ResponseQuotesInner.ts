 ...
 * 
 * @export
 * @interface V2Forward200ResponseQuotesInner
 */
export interface V2Forward200ResponseQuotesInner {
    /**
     * Maturity period of the forward quote
     * @type {string}
     * @memberof V2Forward200ResponseQuotesInner
     */
    tenor: string;
    /**
...
/**
 * Check if a given object implements the V2Forward200ResponseQuotesInner interface.
 */
export function instanceOfV2Forward200ResponseQuotesInner(value: object): value is V2Forward200ResponseQuotesInner {
    if (!('tenor' in value) || value['tenor'] === undefined) return false;
    if ((!('spotBid' in value) && !('spot_bid' in value)) || (value['spotBid'] === undefined && value['spot_bid'] === undefined)) return false;
    if ((!('spotAsk' in value) && !('spot_ask' in value)) || (value['spotAsk'] === undefined && value['spot_ask'] === undefined)) return false;
    if ((!('spotMidpoint' in value) && !('spot_midpoint' in value)) || (value['spotMidpoint'] === undefined && value['spot_midpoint'] === undefined)) return false;
    if ((!('forwardPointsBid' in value) && !('forward_points_bid' in value)) || (value['forwardPointsBid'] === undefined && value['forward_points_bid'] === undefined)) return false;
    if ((!('forwardPointsAsk' in value) && !('forward_points_ask' in value)) || (value['forwardPointsAsk'] === undefined && value['forward_points_ask'] === undefined)) return false;
    return true;
}

export function V2Forward200ResponseQuotesInnerFromJSON(json: any): V2Forward200ResponseQuotesInner {
    return V2Forward200ResponseQuotesInnerFromJSONTyped(json, false);
}

export function V2Forward200ResponseQuotesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2Forward200ResponseQuotesInner {
    if (json == null) {
        return json;
    }
    return {
        ...
        'tenor': json['tenor'],
        'spotBid': json['spot_bid'],
        'spotAsk': json['spot_ask'],
        'spotMidpoint': json['spot_midpoint'],
        'forwardPointsBid': json['forward_points_bid'],
        'forwardPointsAsk': json['forward_points_ask'],
        'sourceDate': json['source_date'] == null ? undefined : json['source_date'],
    };
}

export function V2Forward200ResponseQuotesInnerToJSON(json: any): V2Forward200ResponseQuotesInner {
    return V2Forward200ResponseQuotesInnerToJSONTyped(json, false);
}

export function V2Forward200ResponseQuotesInnerToJSONTyped(value?: V2Forward200ResponseQuotesInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'tenor': value['tenor'],
        'spot_bid': value['spotBid'],
        'spot_ask': value['spotAsk'],
        'spot_midpoint': value['spotMidpoint'],
        'forward_points_bid': value['forwardPointsBid'],
        'forward_points_ask': value['forwardPointsAsk'],
