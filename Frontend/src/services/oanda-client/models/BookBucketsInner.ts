 ...
 * 
 * @export
 * @interface BookBucketsInner
 */
export interface BookBucketsInner {
    /**
     * The lowest price (inclusive) covered by the bucket. The bucket covers the price range from the price to price + the book's bucketWidth. A decimal number encodes as a string. The amount of precision provided depends on the Instrument.
     * @type {string}
     * @memberof BookBucketsInner
     */
    price: string;
    /**
     * The percentage of the total number of orders/positions represented by the long orders/positions found in this bucket. A decimal number encoded as a string. The amount of precision provided depends on what the number represents.
     * @type {string}
     * @memberof BookBucketsInner
     */
    longCountPercent: string;
    /**
     * The percentage of the total number of orders/positions represented by the short orders/positions found in this bucket. A decimal number encoded as a string. The amount of precision provided depends on what the number represents.
     * @type {string}
     * @memberof BookBucketsInner
     */
...
/**
 * Check if a given object implements the BookBucketsInner interface.
 */
export function instanceOfBookBucketsInner(value: object): value is BookBucketsInner {
    if (!('price' in value) || value['price'] === undefined) return false;
    if (!('longCountPercent' in value) || value['longCountPercent'] === undefined) return false;
    if (!('shortCountPercent' in value) || value['shortCountPercent'] === undefined) return false;
    return true;
}

export function BookBucketsInnerFromJSON(json: any): BookBucketsInner {
    return BookBucketsInnerFromJSONTyped(json, false);
}

export function BookBucketsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): BookBucketsInner {
    if (json == null) {
        return json;
    }
    return {
        ...
        'price': json['price'],
        'longCountPercent': json['longCountPercent'],
        'shortCountPercent': json['shortCountPercent'],
    };
}

export function BookBucketsInnerToJSON(json: any): BookBucketsInner {
    return BookBucketsInnerToJSONTyped(json, false);
}

export function BookBucketsInnerToJSONTyped(value?: BookBucketsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'price': value['price'],
        'longCountPercent': value['longCountPercent'],
        'shortCountPercent': value['shortCountPercent'],
    };
}
