...
import type { V2SupportedForwards200ResponseSupportedForwardsInner } from './V2SupportedForwards200ResponseSupportedForwardsInner';
import {
    V2SupportedForwards200ResponseSupportedForwardsInnerFromJSON,
    V2SupportedForwards200ResponseSupportedForwardsInnerFromJSONTyped,
    V2SupportedForwards200ResponseSupportedForwardsInnerToJSON,
    V2SupportedForwards200ResponseSupportedForwardsInnerToJSONTyped,
} from './V2SupportedForwards200ResponseSupportedForwardsInner';

/**
 * 
 * @export
 * @interface V2SupportedForwards200Response
 */
export interface V2SupportedForwards200Response {
    /**
     * 
     * @type {Array<V2SupportedForwards200ResponseSupportedForwardsInner>}
     * @memberof V2SupportedForwards200Response
     */
    supportedForwards: Array<V2SupportedForwards200ResponseSupportedForwardsInner>;
}

/**
 * Check if a given object implements the V2SupportedForwards200Response interface.
 */
export function instanceOfV2SupportedForwards200Response(value: object): value is V2SupportedForwards200Response {
    if ((!('supportedForwards' in value) && !('supported_forwards' in value)) || (value['supportedForwards'] === undefined && value['supported_forwards'] === undefined)) return false;
    return true;
}

export function V2SupportedForwards200ResponseFromJSON(json: any): V2SupportedForwards200Response {
    return V2SupportedForwards200ResponseFromJSONTyped(json, false);
}

export function V2SupportedForwards200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2SupportedForwards200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'supportedForwards': ((json['supported_forwards'] as Array<any>).map(V2SupportedForwards200ResponseSupportedForwardsInnerFromJSON)),
    };
}

export function V2SupportedForwards200ResponseToJSON(json: any): V2SupportedForwards200Response {
    return V2SupportedForwards200ResponseToJSONTyped(json, false);
}

export function V2SupportedForwards200ResponseToJSONTyped(value?: V2SupportedForwards200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'supported_forwards': ((value['supportedForwards'] as Array<any>).map(V2SupportedForwards200ResponseSupportedForwardsInnerToJSON)),
    };
}
