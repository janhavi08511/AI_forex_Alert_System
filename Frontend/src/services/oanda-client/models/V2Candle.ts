...
/**
 * ℹ️ The 'open_time' and 'close_time' of the candle may be
 * earlier than the 'start_time' and 'end_time' requested because the data may have
 * been collected at an earlier date and applied to later candles.
 * 
...
export interface V2Candle {
    /**
     * An uppercase currency code as defined by the Currencies endpoint
     * @type {string}
     * @memberof V2Candle
     */
    baseCurrency: string;
    ...
    /**
     * For the `candle` endpoint this will be the same as the requested `date_time` while for the `candles` endpoint this will either be the same as the requested `start_time` or some days later.
     * @type {string}
     * @memberof V2Candle
     */
    startTime: string;
    /**
     * The recorded open that the data was collected
     * @type {string}
     * @memberof V2Candle
     */
    openTime: string;
    /**
     * The recorded close that the data was collected
     * @type {string}
     * @memberof V2Candle
     */
    closeTime: string;
    /**
     * Rates are encoded as string to prevent rounding issues
     * @type {string}
     * @memberof V2Candle
     */
    openBid?: string;
    ...
    lowMidpoint?: string;
    /**
     * This represents the latest time at which data for the given currency pair was published in the dataset.
     * @type {string}
     * @memberof V2Candle
     */
    sourecDate?: string;
...
/**
 * Check if a given object implements the V2Candle interface.
 */
export function instanceOfV2Candle(value: object): value is V2Candle {
    if ((!('baseCurrency' in value) && !('base_currency' in value)) || (value['baseCurrency'] === undefined && value['base_currency'] === undefined)) return false;
    if ((!('quoteCurrency' in value) && !('quote_currency' in value)) || (value['quoteCurrency'] === undefined && value['quote_currency'] === undefined)) return false;
    if ((!('startTime' in value) && !('start_time' in value)) || (value['startTime'] === undefined && value['start_time'] === undefined)) return false;
    if ((!('openTime' in value) && !('open_time' in value)) || (value['openTime'] === undefined && value['open_time'] === undefined)) return false;
    if ((!('closeTime' in value) && !('close_time' in value)) || (value['closeTime'] === undefined && value['close_time'] === undefined)) return false;
    return true;
}

export function V2CandleFromJSON(json: any): V2Candle {
    return V2CandleFromJSONTyped(json, false);
}

export function V2CandleFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2Candle {
    if (json == null) {
        return json;
    }
    return {
        ...
        'openBid': json['open_bid'] == null ? undefined : json['open_bid'],
        'openAsk': json['open_ask'] == null ? undefined : json['open_ask'],
        'openMidpoint': json['open_midpoint'] == null ? undefined : json['open_midpoint'],
        'closeBid': json['close_bid'] == null ? undefined : json['close_bid'],
        'closeAsk': json['close_ask'] == null ? undefined : json['close_ask'],
        'closeMidpoint': json['close_midpoint'] == null ? undefined : json['close_midpoint'],
        'averageBid': json['average_bid'] == null ? undefined : json['average_bid'],
        'averageAsk': json['average_ask'] == null ? undefined : json['average_ask'],
        'averageMidpoint': json['average_midpoint'] == null ? undefined : json['average_midpoint'],
        'highBid': json['high_bid'] == null ? undefined : json['high_bid'],
        'highAsk': json['high_ask'] == null ? undefined : json['high_ask'],
        'highMidpoint': json['high_midpoint'] == null ? undefined : json['high_midpoint'],
        'lowBid': json['low_bid'] == null ? undefined : json['low_bid'],
        'lowAsk': json['low_ask'] == null ? undefined : json['low_ask'],
        'lowMidpoint': json['low_midpoint'] == null ? undefined : json['low_midpoint'],
        'sourecDate': json['sourec_date'] == null ? undefined : json['sourec_date'],
    };
}

export function V2CandleToJSON(json: any): V2Candle {
    return V2CandleToJSONTyped(json, false);
}

export function V2CandleToJSONTyped(value?: V2Candle | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'open_bid': value['openBid'],
        'open_ask': value['openAsk'],
        'open_midpoint': value['openMidpoint'],
        'close_bid': value['closeBid'],
        'close_ask': value['closeAsk'],
        'close_midpoint': value['closeMidpoint'],
        'average_bid': value['averageBid'],
        'average_ask': value['averageAsk'],
        'average_midpoint': value['averageMidpoint'],
        'high_bid': value['highBid'],
        'high_ask': value['highAsk'],
        'high_midpoint': value['highMidpoint'],
        'low_bid': value['lowBid'],
        'low_ask': value['lowAsk'],
        'low_midpoint': value['lowMidpoint'],
        'sourec_date': value['sourecDate'],
    };
}
