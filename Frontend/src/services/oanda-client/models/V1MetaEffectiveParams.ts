 ...
 * @export
 * @interface V1MetaEffectiveParams
 */
export interface V1MetaEffectiveParams {
    /**
     * 
     * @type {Dataset}
     * @memberof V1MetaEffectiveParams
     */
    dataSet: Dataset;
    /**
     * Format: YYYY-MM-DD. Interpreted in UTC timezone. Must be earlier than or equivalent to today's date.
     * @type {string}
     * @memberof V1MetaEffectiveParams
     */
    date?: string;
...
/**
 * Check if a given object implements the V1MetaEffectiveParams interface.
 */
export function instanceOfV1MetaEffectiveParams(value: object): value is V1MetaEffectiveParams {
    if ((!('dataSet' in value) && !('data_set' in value)) || (value['dataSet'] === undefined && value['data_set'] === undefined)) return false;
    if ((!('decimalPlaces' in value) && !('decimal_places' in value)) || (value['decimalPlaces'] === undefined && value['decimal_places'] === undefined)) return false;
    if (!('fields' in value) || value['fields'] === undefined) return false;
    if ((!('quoteCurrencies' in value) && !('quote_currencies' in value)) || (value['quoteCurrencies'] === undefined && value['quote_currencies'] === undefined)) return false;
    return true;
}

export function V1MetaEffectiveParamsFromJSON(json: any): V1MetaEffectiveParams {
    return V1MetaEffectiveParamsFromJSONTyped(json, false);
}

export function V1MetaEffectiveParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1MetaEffectiveParams {
    if (json == null) {
        return json;
    }
    return {
        
        'dataSet': DatasetFromJSON(json['data_set']),
        'date': json['date'] == null ? undefined : json['date'],
        'end': json['end'] == null ? undefined : json['end'],
        'decimalPlaces': json['decimal_places'],
        'fields': json['fields'],
        'quoteCurrencies': json['quote_currencies'],
        'start': json['start'] == null ? undefined : json['start'],
    };
}

export function V1MetaEffectiveParamsToJSON(json: any): V1MetaEffectiveParams {
    return V1MetaEffectiveParamsToJSONTyped(json, false);
}

export function V1MetaEffectiveParamsToJSONTyped(value?: V1MetaEffectiveParams | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data_set': DatasetToJSON(value['dataSet']),
        'date': value['date'],
        'end': value['end'],
        'decimal_places': value['decimalPlaces'],
        'fields': value['fields'],
        'quote_currencies': value['quoteCurrencies'],
        'start': value['start'],
    };
}
