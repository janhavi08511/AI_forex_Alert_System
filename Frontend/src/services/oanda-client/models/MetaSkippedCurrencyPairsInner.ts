 ...
 * 
 * @export
 * @interface MetaSkippedCurrencyPairsInner
 */
export interface MetaSkippedCurrencyPairsInner {
    /**
     * An uppercase currency code as defined by the Currencies endpoint
     * @type {string}
     * @memberof MetaSkippedCurrencyPairsInner
     */
    baseCurrency: string;
    /**
     * An uppercase currency code as defined by the Currencies endpoint
...
/**
 * Check if a given object implements the MetaSkippedCurrencyPairsInner interface.
 */
export function instanceOfMetaSkippedCurrencyPairsInner(value: object): value is MetaSkippedCurrencyPairsInner {
...
export function MetaSkippedCurrencyPairsInnerFromJSON(json: any): MetaSkippedCurrencyPairsInner {
    return MetaSkippedCurrencyPairsInnerFromJSONTyped(json, false);
}

export function MetaSkippedCurrencyPairsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetaSkippedCurrencyPairsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function MetaSkippedCurrencyPairsInnerToJSON(json: any): MetaSkippedCurrencyPairsInner {
    return MetaSkippedCurrencyPairsInnerToJSONTyped(json, false);
}

export function MetaSkippedCurrencyPairsInnerToJSONTyped(value?: MetaSkippedCurrencyPairsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
