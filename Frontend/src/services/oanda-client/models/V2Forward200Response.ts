...
import type { V2Forward200ResponseQuotesInner } from './V2Forward200ResponseQuotesInner';
import {
    V2Forward200ResponseQuotesInnerFromJSON,
    V2Forward200ResponseQuotesInnerFromJSONTyped,
    V2Forward200ResponseQuotesInnerToJSON,
    V2Forward200ResponseQuotesInnerToJSONTyped,
} from './V2Forward200ResponseQuotesInner';

/**
 * 
 * @export
 * @interface V2Forward200Response
 */
export interface V2Forward200Response {
    /**
     * 
     * @type {Meta}
     * @memberof V2Forward200Response
     */
    meta: Meta;
    /**
     * 
     * @type {Array<V2Forward200ResponseQuotesInner>}
     * @memberof V2Forward200Response
     */
    quotes: Array<V2Forward200ResponseQuotesInner>;
}

/**
 * Check if a given object implements the V2Forward200Response interface.
 */
export function instanceOfV2Forward200Response(value: object): value is V2Forward200Response {
    if (!('meta' in value) || value['meta'] === undefined) return false;
    if (!('quotes' in value) || value['quotes'] === undefined) return false;
    return true;
}

export function V2Forward200ResponseFromJSON(json: any): V2Forward200Response {
    return V2Forward200ResponseFromJSONTyped(json, false);
}

export function V2Forward200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2Forward200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'quotes': ((json['quotes'] as Array<any>).map(V2Forward200ResponseQuotesInnerFromJSON)),
    };
}

export function V2Forward200ResponseToJSON(json: any): V2Forward200Response {
    return V2Forward200ResponseToJSONTyped(json, false);
}

export function V2Forward200ResponseToJSONTyped(value?: V2Forward200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'quotes': ((value['quotes'] as Array<any>).map(V2Forward200ResponseQuotesInnerToJSON)),
    };
}
