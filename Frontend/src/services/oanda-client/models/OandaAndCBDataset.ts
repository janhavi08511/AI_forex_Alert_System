 ...
 * @export
 */
export const OandaAndCBDataset = {
    Oanda: 'OANDA',
    Aecb: 'AECB',
    Alcb: 'ALCB',
    Amcb: 'AMCB',
...
export type OandaAndCBDataset = typeof OandaAndCBDataset[keyof typeof OandaAndCBDataset];


export function instanceOfOandaAndCBDataset(value: any): boolean {
    for (const key in OandaAndCBDataset) {
        if (Object.prototype.hasOwnProperty.call(OandaAndCBDataset, key)) {
            if (OandaAndCBDataset[key as keyof typeof OandaAndCBDataset] === value) {
                return true;
            }
        }
    }
...
export function OandaAndCBDatasetFromJSON(json: any): OandaAndCBDataset {
    return OandaAndCBDatasetFromJSONTyped(json, false);
}

export function OandaAndCBDatasetFromJSONTyped(json: any, ignoreDiscriminator: boolean): OandaAndCBDataset {
    return json as OandaAndCBDataset;
}

export function OandaAndCBDatasetToJSON(value?: OandaAndCBDataset | null): any {
    return value as any;
}

export function OandaAndCBDatasetToJSONTyped(value: any, ignoreDiscriminator: boolean): OandaAndCBDataset {
    return value as OandaAndCBDataset;
}
